...
class MyTrainingArguments(Seq2SeqTrainingArguments):
    ...
    max_length: int = field(default=1024, metadata={"help": "The maximum length of the sequence to be generated."})
    ...
    llama_type: str = field(default='7b')
    general_importance_dir: str = field(default='importance/')
